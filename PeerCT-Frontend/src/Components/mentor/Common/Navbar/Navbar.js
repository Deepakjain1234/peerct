    ...
    return (
        ...
        <div className='navbar'>
            ...
            <div className='logo-space'>
                ...
                <DensityMediumIcon  style={{ color: "white" }} for='check1'/>
            ...
            <div className="sell-btn btn"> <button>Home</button> </div>
            <div className="sell-btn btn">	 <button>Find a Mentor</button> </div>
