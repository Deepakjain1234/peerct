          ...
          <section className='main-dashborad'>
            <div className='dashboard-left'>
                ...
                <div className='side-bar-option'>
                    ...
                    <div className='option-side-bar'onClick={()=>setactive("network")}><h3>My network</h3></div>
                    <div className='option-side-bar'><Link to="/mentor/mentorprofile/:id"><h3>My profile</h3></Link></div>
                    ...
                    <div className='option-side-bar' onClick={()=>setactive("setting")}><h3>Settings</h3></div>
                    <div className='option-side-bar' onClick={()=>setactive("support")}><h3>support</h3></div>
            ...
            <div className='dasboard-right'>
                ...
                {activenav=="network" && <div className='chat-box'><Network /> </div>}
                {activenav=="support" && <div className='chat-box'><Support /> </div>}
                {activenav=="setting" && <div className='chat-box'><Setting /> </div>}
