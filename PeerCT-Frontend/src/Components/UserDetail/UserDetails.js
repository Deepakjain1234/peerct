                    ...
                    {/* <div className="personal-info">
                        <form className="personal-info">
                            ...
                            <div className="name-section inputs-user"><div className='common-labels'>
                                ...
                                <label className='last' htmlFor="">edit</label></div>
                                <div className="inp-name">
                                    <input type="text" name="" id="" value={userDetails.name} />
                            ...
                            <div className="name-section inputs-user"><div className='common-labels'>
                                ...
                                <label className='last' htmlFor="">edit</label></div>
                                <div className="inp-name">
                                    <input type="text" name="" id="" value={userDetails.email} />
                                </div>
                            </div>
                            <div className="name-section inputs-user"><div className='common-labels'>
                                ...
                                <label className='last' htmlFor="">edit</label></div>
                                <div className="inp-name">
                                    <input type="text" name="" id="" value={userDetails.contact} />
                                </div>
                            </div>
                        </form>
                    </div> */}
